<?php
	...
	*/
	...
	else
	{
		...
		{
			'<div class="error"><p>The WooCommerce plugin needs to be enabled to use the Product Subscription For WooCommerce plugin.</p></div>';
		}
		add_action('admin_notices', 'wprne_woocommerce_inactive');
	}
